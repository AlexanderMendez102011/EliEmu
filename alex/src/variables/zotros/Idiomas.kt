...
object Idiomas {
    private val textosEN: List<String> = ArrayList()
    private val textosES: List<String> = ArrayList()

    @SuppressWarnings("unused")
    private val textosFR: List<String> = ArrayList()
    fun getTexto(idioma: String?, valor: Int): String {
        return when (idioma) {
            "es" -> textosES[valor]
            "en" -> textosEN[valor]
            "fr" -> textosES[valor]
    ...
    fun cargarIdiomaES() {
        ...
        index++
        textosES.add(index, "Esta opci�n no est� habilitada todav�a")
        index++
        textosES.add(index, "Vuestro amor ya no est� en l�nea")
        index++
        ...
        index++ //12
        textosES.add(index, "No puedes equiparte una mascota si est�s subido a una montura")
        index++
        textosES.add(index, "No puedes poner un objeto viviente encima de otro")
        index++
        textosES.add(index, "El objeto no existe o est� bugeado, intenta cambiar de personaje para evitar m�s errores")
        index++
        textosES.add(index, "No se le pueden equipar objetos vivientes a los sets de clase")
        index++ //16
        textosES.add(index, "Tus oficios est�n ahora en modo p�blico y est�s catalogado en la lista de los artesanos")
        index++
        textosES.add(index, "Ya no est�s catalogado en la lista de los artesanos")
        index++
        ...
        index++
        textosES.add(index, "Ya est�s en un crafteo")
        index++
        ...
        index++
        textosES.add(index, "S�lo se pueden agregar runas de 300 en 300")
        index++ //26
        textosES.add(index, "Los Objevivo no se pueden poner en venta")
        index++ //27
        textosES.add(index, "El m�ximo valor de Kamas para ingresar es 999.999.999")
        index++
        textosES.add(index, "S�lo puedes poner <b>x1 Polvo de resurecci�n</b> o <b>x1 Fantasma de Mascota</b>")
        index++
        textosES.add(index, "Necesitas 200.000 Kamas para poder perfeccionar un objeto")
        index++
        textosES.add(index, "S�lo puedes poner un objeto para perfeccionar")
        index++
        ...
        index++ //35
        textosES.add(index, "S�lo puedes poner objetos R1, R2 y R3")
        index++ //36
        ...
        index++ //
        textosES.add(index, "Espera 3 seg antes de usar esta acci�n de nuevo.")
        index++ //
        ...
        index++ //45
        textosES.add(index, "cMK|-99|Zino|Ahora f�jate en los stats del Objeto creado|")
        index++ //
        ...
        index++ //50
        textosES.add(index, "El m�ximo de minerales que puedes agregar son 3")
        index++ //
        ...
        index++ //56
        textosES.add(index, "Gracias por comprar en DofusAstro. A�n te quedan ")
        index++ //57
        textosES.add(index, "No puedes comprar tantos items a la vez")
        index++ //58
        ...
        index++ //
        textosES.add(index, "No puedes iniciar un intercambio mientras est�s de esclavo en un grupo de Maitre")
        index++ //62
        textosES.add(index, "Acci�n deshabilitada temporalmente")
        index++ //63
        textosES.add(index, "<b>El personaje mercante estaba bug y ha sido retirado con �xito</b>")
        index++ //
        textosES.add(index, "No puedes usar este comando en combate")
        index++ //65
        textosES.add(index, "No puedes usar este comando mientras est�s en un intercambio")
        index++ //
        textosES.add(index, "No puedes usar este comando mientras est�s en una acci�n")
        index++ //
        textosES.add(index, "No puedes usar este comando porque est�s ocupado")
        index++ //
        textosES.add(index, "Has llegado al inicio")
        index++ //
        textosES.add(index, "Los comandos disponibles son:\n<b>.astrub</b> - Te lleva al Zaap de Astrub\n<b>.start</b> - Te lleva al mapa de Inicio\n<b>.pvp</b> - Te lleva al mapa PvP\n<b>.shop</b> - Te lleva al mapa de Shop\n<b>.puntos</b> - Te muestra tus Puntos VIP disponibles\n<b>.vida</b> - Te restaura toda la vida\n<b>.taller</b> - Te lleva al taller de FM")
        index++ //
        textosES.add(index, "Has llegado al mapa PvP")
        index++ //71
        textosES.add(index, "Has llegado a la Taberna")
        index++ //
        textosES.add(index, "S�lo puedes usar el editor de casas estando en tu propia casa")
        index++ //73
        textosES.add(index, "Has reiniciado tu casa con �xito")
        index++ //74
        ...
        index++ //
        textosES.add(index, "No puedes realizar acciones mientras est�s en un grupo de Maitre")
        index++ //
        textosES.add(index, "No puedes atacar Recaudadores mientras est�s en un grupo de Maitre")
        index++ //
        textosES.add(index, "No puedes atacar Prismas mientras est�s en un grupo de Maitre")
        index++ //
        textosES.add(index, "Necesitas una alineaci�n para poder atacar un prisma")
        index++ //86
        ...
        index++ //88
        textosES.add(index, "No puedes agredir a alguien mientras est�s en un Torneo")
        index++ //
        textosES.add(index, "No puedes desafiar a alguien mientras est� en un Torneo")
        index++ //90
        textosES.add(index, "No puedes desafiar a alguien que est� en un grupo de Maitre")
        index++ //
        textosES.add(index, "No puedes agredir a esta persona porque est� realizando una acci�n")
        index++ //
        textosES.add(index, "No puedes agredir a alguien que est� en un grupo de Maitre")
        index++ //
        textosES.add(index, "No puedes agredir a la misma persona otra vez. Para volver a agredirla, necesitas agredir a otras 3 personas diferentes")
        index++ //
        textosES.add(index, "No puedes agredir a tus propias cuentas")
        index++ //95
        textosES.add(index, "No puedes agredir a alguien mientras est� en un Torneo")
        index++ //
        textosES.add(index, "No puedes agredir a alguien neutral")
        index++ //
        textosES.add(index, "El objetivo se encuentra en una agresi�n")
        index++ //98
        textosES.add(index, "No puedes desafiar a alguien mientras est�s en un Torneo")
        index++ //99
        textosES.add(index, "S�lo el lider del grupo se puede mover por el mapa")
        index++ //
        textosES.add(index, "Acabas de salir del rango de Maitre, si el lider se mueve por este mapa, no te llevar� con �l")
        index++ //101
        textosES.add(index, "Espera 5 segundos antes de volver a inscribirte")
        index++ //102
        textosES.add(index, "Te has unido a una cola de espera junto a una persona m�s")
        index++ //103
        textosES.add(index, "Te has unido a una cola de espera junto a ")
        index++ //104
        textosES.add(index, " personas m�s")
        index++ //
        textosES.add(index, " acaba de unirse al grupo de Koliseo")
        index++ //
        textosES.add(index, "Ya est�s inscrito en un Koliseo")
        index++ //
        textosES.add(index, "No est�s inscrito en ning�n Koliseo")
        index++ //
        textosES.add(index, "La fase 2 del Torneo empezar� pronto")
        index++ //109
        textosES.add(index, "La fase 3 del Torneo empezar� pronto")
        index++ //
        ...
        index++ //113
        textosES.add(index, "La pelea empezar� en unos segundos!!!")
        index++ //
        textosES.add(index, "No puedes desinscribirte del Torneo porque ya ha empezado")
        index++ //
        textosES.add(index, "Ya no est�s en el Torneo")
        index++ //116
        textosES.add(index, "No puedes inscribirte al Torneo porque ya ha empezado")
        index++ //
        textosES.add(index, "Ya est�s inscrito en el Torneo")
        index++ //
        textosES.add(index, "El Torneo est� lleno, pronto comenzar�n las partidas")
        index++ //
        textosES.add(index, "No puedes inscribir multicuentas al Torneo")
        index++ //
        textosES.add(index, "Hubo un error al inscribirse, int�ntalo de nuevo m�s tarde")
        index++ //11
        textosES.add(index, "El Torneo empezar� en 5 segundos")
        index++ //
        textosES.add(index, "<b>RECUERDA:</b> La primera fase ser� aleatoria y se mezclar�n todos los personajes aleatoriamente")
        index++ //
        textosES.add(index, "No hay ning�n Torneo programado todav�a")
        index++ //124
        textosES.add(index, "Error al reclamar el objeto")
        index++ //
        textosES.add(index, "Ya has reclamado el m�ximo de objetos por este combate, recuerda que s�lo puedes reclamar ")
        index++ //
        ...
        index++ //
        textosES.add(index, "Objeto reclamado con �xito.")
        index++ //
        textosES.add(index, "Necesitas 5 Puntos VIP para cambiar de color")
        index++ //130
        textosES.add(index, "<b>Tu mensaje ha sido enviado con �xito.</b>")
        index++ //
        textosES.add(index, "Ya est�s en un Grupo Maitre y eres el l�der")
        index++ //
        textosES.add(index, "Ya est�s en un Grupo Maitre y eres el esclavo")
        index++ //
        ...
        index++ //
        textosES.add(index, "S�lo puedes hacer Maitre con tus propias cuentas")
        index++ //136
        textosES.add(index, "Recuerda:\n\n Si vas a nuestra p�gina web, te conectas con tu cuenta y le das al bot�n \n\nMi Cuenta\n\nPuedes ganar +300 Puntos VIP si compartes la p�gina por FaceBook")
        index++ //
        ...
        index++
        textosES.add(index, "No puedes usar fusionar estos 2 objetos de distinto tipo, s�lo puedes fusionar entre s� Armas, Sombreros, Capas, Mascotas y Escudos y objetos del mismo tipo.")
        index++
        ...
        index++
        textosES.add(index, "<b>[EVENTO R3]:</b> Un �ngel de la creaci�n ha ca�do del cielo, est� en la zona del Rinc�n de los Tofus (Debajo de Astrub)")
        index++ //151
        textosES.add(index, "<b>[EVENTO R3]:</b> Un demonio se ha alzado de las profundidades del infierno, est� en la zona del Rinc�n de los Tofus (Debajo de Astrub)")
        index++ //152
        textosES.add(index, "<b>[EVENTO R3]:</b> Un �ngel de la creaci�n ha ca�do del cielo, est� en la zona de Tainela La Cuna")
        index++ //
        textosES.add(index, "<b>[EVENTO R3]:</b> Un demonio se ha alzado de las profundidades del infierno, est� en la zona de Tainela La Cuna")
        index++ //
        textosES.add(index, "S�lo los R3 pueden unirse a este combate")
        index++ //155
        textosES.add(index, "El combate empezar� en unos segundos, no te puedes unir ahora")
        index++ //
        ...
        index++ //
        textosES.add(index, "En las mazmorras s�lo se permiten 3 cuentas por IP en una misma pelea")
        index++ //
        textosES.add(index, "En las peleas de evento s�lo se permite 1 cuenta por IP en una misma pelea")
        index++ //162
        textosES.add(index, "No puedes unirte a un combate de Desaf�o Diario")
        index++ //163
        ...
        index++ //175
        textosES.add(index, "<b>[EVENTO GLOBAL]:</b> El bot�n de Kamas ha sido encontrado y se han llevado 500.000 Kamas")
        index++ //176
        ...
        index++ //179
        textosES.add(index, "S�lo puedes poner Armas y P�cimas")
        index++ //180
        ...
        index++
        textosES.add(index, "Necesitas completar la misi�n de las Mazmorras R0 para poder cambiar el elemento de un Arma")
        index++ //183
        textosES.add(index, "Tienes que poner x1 Arma y x1 P�cima")
        index++ //184
        textosES.add(index, "<b>[EVENTO GLOBAL]:</b> Un portal interdimensional se ha abierto en el Cementerio de Bonta. Se mantendr� abierto 10 minutos y luego empezar� el evento")
        index++ //185
        textosES.add(index, " ha cruzado el portal")
        index++ //186
        textosES.add(index, "El portal se ha cerrado y el evento ha comenzado!!!")
        index++ //187
        textosES.add(index, "Bienvenido a WakfuServer, en tu inventario encontraras el Set R1 para que empieces esta aventura!!!|")
        index++ //188
        textosES.add(index, "Deberas empezar por hacer mis misiones, yo te brindare todo lo necesario para que tengas estabilidad en este mundo|")
        index++ //189
        textosES.add(index, "En tu menu encontraras un boton de Objetivos Diarios.|")
        index++ //190
        textosES.add(index, "Te recomiendo completar todos Objetivos Diarios y todas las misiones que tengas disponibles|")
        index++ //191
        textosES.add(index, "Tambien encontraras a el Npc de misiones secundarias con el podras obtener Ogrinas, Dofus, y explorar el mundo|")
        index++ //192
        textosES.add(index, "Recuerda que puedes ver los comandos disponibles escribiendo .comandos|")
        index++ //193
        textosES.add(index, "En este servidor tienes la posibilidad de contar con un album donde estaran almacenado los drops de cada mob y una enciclopedia de items.")
        index++ //194
        textosES.add(index, "Aqui podras ver la informacion del drop de items de todos los mobs del servidor y todos los objetos del mismo.|")
        index++ //195
        textosES.add(index, "La moneda principal del servidor es la Ogrina asi que cuidala!|")
        index++ //196
        textosES.add(index, "Todo esto y mucho m�s, ya lo ir�s descubriendo explorando el servidor, que te diviertas!!!|")
        index++ //197
        ...
        index++ //203
        textosES.add(index, "Los miembros NO-Vip s�lo pueden curarse el 80% de su vida")
        index++ //204
        textosES.add(index, "<b>[EVENTO GLOBAL]:</b> Un Mercader Misterioso ha aparecido por las Praderas de Astrub. Se quedar� <b>5 minutos</b> y luego desaparecer�!!!")
        index++ //205
        textosES.add(index, "El Mercader Misterioso ha desaparecido!!!")
        index++ //206
        textosES.add(index, "S�lo se pueden comprar 2 objetos por persona")
        index++ //207
        textosES.add(index, "<b>[EVENTO GLOBAL]:</b> La temporada de caza ha empezado!!! Escribe <b>.evento</b> y caza todos los Jalat�s que puedas!!! Termina en <b>5 minutos</b>")
        index++ //208
        textosES.add(index, "<b>[EVENTO GLOBAL]:</b> Una misteriosa carrera se llevar� a cabo!!! Escribe <b>.evento</b> y apuesta por un ganador!!! La carrera empieza en <b>3 minutos</b>")
        index++ //209
        textosES.add(index, "Ha empezado la carrera de Larvas!!! Qui�n ser� el ganador???")
        index++ //210
        textosES.add(index, "El evento de Larvas ha finalizado!!!")
        index++ //211
        textosES.add(index, " Moneda(s) de la Fraternidad")
        index++ //212
        textosES.add(index, " Moneda(s) R0")
        index++ //213
        textosES.add(index, " Moneda(s) R1")
        index++ //214
        textosES.add(index, " Moneda(s) R2")
        index++ //215
        textosES.add(index, " Moneda(s) R3")
        index++ //216
        textosES.add(index, " Doplon(es)")
        index++ //217
    }
    ...
    fun cargarIdiomaEN() {
        ...
        index++ //56
        textosEN.add(index, "Thank you for shopping at DofusAstro. You still have ")
        index++ //57
        textosEN.add(index, "You can't buy as many items at once")
        index++ //58
        ...
        index++ //
        textosEN.add(index, "You cannot attack the same person again. To attack her again, you need to attack 3 other different people")
        index++ //
        ...
        index++ //
        textosEN.add(index, "You just got out of Maitre's range, if the leader moves across this map, he won't take you with him")
        index++ //101
        ...
        index++ //
        textosEN.add(index, "<b>REMEMBER:</b> The first phase will be random and all the characters will be randomly mixed")
        index++ //
        textosEN.add(index, "There is no Tournament scheduled yet")
        index++ //124
        textosEN.add(index, "Failed to claim the object")
        index++ //
        textosEN.add(index, "You have already claimed the maximum amount of items for this combat, remember that you can only claim ")
        index++ //
        ...
        index++
        textosEN.add(index, "You cannot use merge these 2 objects of different types, you can only merge Weapons, Hats, Cloaks, Pets and Shields and objects of the same type with each other.")
        index++
        ...
        index++
        textosEN.add(index, "<b>[EVENT R3]:</b> An angel of creation has fallen from the sky, is in the area of the Corner of the Tofus (Below Astrub)")
        index++ //151
        textosEN.add(index, "<b>[EVENT R3]:</b> A demon has risen from the depths of hell, he is in the area of the Corner of the Tofus (Below Astrub)")
        index++ //152
        textosEN.add(index, "<b>[EVENT R3]:</b> An angel of creation has fallen from the sky, is in the area of Tainela La Cuna")
        index++ //
        textosEN.add(index, "<b>[EVENT R3]:</b> A demon has risen from the depths of hell, it is in the area of Tainela La Cuna")
        index++ //
        ...
        index++ //184
        textosEN.add(index, "<b>[GLOBAL EVENT]:</b> An interdimensional portal has been opened in the Bontaa Cemetery. It will stay open 10 minutes and then the event will start")
        index++ //185
        textosEN.add(index, " has crossed the portal")
        index++ //186
        textosEN.add(index, "The portal has closed and the event has started !!!")
        index++ //187
        textosEN.add(index, "Welcome to DofusAstro, remember that you have your Kamas in the bank!!!|")
        index++ //188
        ...
        index++ //193
        textosEN.add(index, "In this server you have the possibility to customize your own house, I will show you an example|")
        index++ //194
        textosEN.add(index, "This is the House Editor, you can remove the objects from your house and customize it to your liking!!!|")
        index++ //195
        textosEN.add(index, "Remember that having a House is NOT Free and you will have to pay taxes for it, you can pay taxes by visiting the Banker|")
        index++ //196
        ...
        index++ //204
        textosEN.add(index, "<b>[GLOBAL EVENT]:</b> A Mysterious Merchant has appeared through the Astrub Grasslands. It will stay <b>5 minutes</b> and then disappear!!!")
        index++ //205
        textosEN.add(index, "The Mysterious Merchant has disappeared!!!")
        index++ //206
        textosEN.add(index, "You can only buy 2 items per person")
        index++ //207
        textosEN.add(index, "<b>[GLOBAL EVENT]:</b> The hunting season has started!!! Go to <b>.event</b> and hunt all the Gobballs you can!!! Finishes in <b>5 minutes</b>")
        index++ //208
        textosEN.add(index, "<b>[GLOBAL EVENT]:</b> A mysterious race will take place!!! Type <b>.event</b> and bet on a winner!!! The race starts in <b>3 minutes</b>")
        index++ //209
